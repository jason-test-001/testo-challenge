...
public class AdminTest {
    ...
    /**
     * login as admin, admin has the permission to run all method see all statistic
     *
     * @return
     */
    @Test
